    ...
    return (
        <>
            <div>
                ...
                <div className='flex flex-col gap-4 items-center justify-center mx-25 '>
                    <p className='text-gray-400 font-space'>Hello, I am <span className='text-purple-400 uppercase'>Nishant Chaudhary</span>.</p>
                ...
                <button className='border flex items-center justify-center gap-5 border-purple-400 text-gray-400 text-lg p-3 font-space rounded-md cursor-pointer ml-24 mt-10 hover:bg-purple-400 hover:text-gray-900'>Know More <FaArrowRight/></button>
            </div>
        </>
    )
}